...
@section('title', 'কোটেশন')

@section('content')
<div class="flex items-center justify-between mb-5">
    <h2 class="text-xl font-bold text-gray-800">কোটেশন (Monitoring)</h2>
    <div class="flex gap-2">
        @foreach(['all' => 'সব', 'sent_to_customer' => 'পাঠানো', 'accepted' => 'গৃহীত', 'converted_to_order' => 'অর্ডার', 'rejected' => 'প্রত্যাখ্যাত'] as $s => $label)
    ...
    <table class="w-full text-sm">
        <thead class="bg-gray-50 border-b">
            <tr>
                ...
                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase hidden sm:table-cell">Supplier</th>
                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase">ইউনিট মূল্য</th>
                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase hidden md:table-cell">মোট</th>
                <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase">স্ট্যাটাস</th>
        ...
        <tbody class="divide-y divide-gray-50">
            ...
            <tr class="hover:bg-gray-50">
                ...
                <td class="px-4 py-3 text-gray-600 hidden sm:table-cell">{{ $quote->vendor?->shop_name ?? $quote->vendor?->owner_name ?? 'মসলামার্ট' }}</td>
