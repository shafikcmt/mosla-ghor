    ...
    <div class="md:col-span-2 border border-green-200 bg-green-50/50 rounded-lg p-4 space-y-3">
        ...
        <label class="flex items-start gap-3 cursor-pointer">
            ...
            <span class="text-sm text-gray-700">
                ...
                <span class="block text-xs text-gray-400 font-normal">পাইকারি (Paykari) তালিকায় দাম লুকানো থাকবে — গ্রাহক শুধু enquiry পাঠাবে, supplier/admin quote দেবে।</span>
            </span>
        </label>
    </div>
