...
@section('title', 'পিকআপ পয়েন্ট সম্পাদনা')
...
<div class="bg-white rounded shadow p-6 max-w-2xl">
    ...
    <form method="POST" action="{{ route('vendor.pickup-points.update', $pickupPoint) }}" class="space-y-4">
        @csrf @method('PUT')
        @include('vendor.pickup-points._form')

        <div class="flex gap-3 pt-2">
            <button type="submit" class="bg-[#4338ca] text-white text-sm px-5 py-2 rounded hover:bg-[#3730a3] transition-colors">আপডেট করুন</button>
